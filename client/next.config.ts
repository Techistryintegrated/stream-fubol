const csp = `
  default-src 'self';
  script-src-elem 'self' 'unsafe-inline' 'unsafe-eval' *.vercel-insights.com https://www.googletagmanager.com https://www.google-analytics.com https://pagead2.googlesyndication.com https://adservice.google.com https://securepubads.g.doubleclick.net https://www.gstatic.com https://ep2.adtrafficquality.google https://connect.facebook.net/en_US/fbevents.js https://www.facebook.com/tr?id=2587638381589796&ev=PageView&noscript=1;
  ...
  frame-src 'self' https://*.scoreswift.in https://googleads.g.doubleclick.net https://tpc.googlesyndication.com https://www.youtube.com;
